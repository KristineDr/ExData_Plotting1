...
#1st plot
plot1<-plot(time_axis, data[, 3], xlab = "", ylab = "Global Active Power (kilowatts)", type = "l")
...
plot3<-plot(time_axis, data[, 7], xlab = "", ylab = "Energy sub metering", type = "l")
lines(time_axis, data[, 8], col = "red")
lines(time_axis, data[, 9], col = "blue")
...
plot4<-plot(time_axis, data[, 4], xlab = "datetime", ylab = "Global_reactive_power", type = "l")
